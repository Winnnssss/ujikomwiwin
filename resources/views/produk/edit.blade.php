                ...
                <div class="pd-30 pd-sm-40 bg-gray-100">
                    ...
                    <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" value="{{ $dt->Nama_produk }}" placeholder="silahkan isi" name="Nama_produk" type="text">
                        </div>
                    </div>
                    <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" value="{{ $dt->Harga }}" placeholder="silahkan isi" name="Harga" type="number">
                        </div>
                    </div>
                    <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" value="{{ $dt->Stok }}" placeholder="masukan stok" name="Stok" type="number">
                        </div>
                    </div>
