                ...
                <div class="pd-30 pd-sm-40 bg-gray-100">
                    ...
                    <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" placeholder="silahkan isi" name="Nama_produk"  value="{{ old('Nama_produk') }}" type="text">
                        </div>
                    </div>
                    <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" placeholder="silahkan isi" name="Harga"  value="{{ old('Harga') }}" type="number">
                        </div>
                    </div>
                    <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" placeholder="silahkan isi" name="Stok"  value="{{ old('Stok') }}" type="number">
                        </div>
                    </div>
